...
class ARFobject:
    ...
    print row_format.format(*self.int_registers[0:8])
    reg_names = ["R8", "R9", "R10", "R11", "R12", "R13", "R14", "R15"]
    print row_format.format(*reg_names)
    print row_format.format(*self.int_registers[8:16])
    reg_names = ["R16", "R17", "R18", "R19", "R20", "R21", "R22", "R23"]
    print row_format.format(*reg_names)
    print row_format.format(*self.int_registers[16:24])
    reg_names = ["R24", "R25", "R26", "R27", "R28", "R29", "R30", "R31"]
    print row_format.format(*reg_names)
    print row_format.format(*self.int_registers[24:32])
    print "########################################################################################################################################################"    
    reg_names = ["F0", "F1", "F2", "F3", "F4", "F5", "F6", "F7"]
    print row_format.format(*reg_names)
    print row_format.format(*self.fp_registers[0:8])
    reg_names = ["F8", "F9", "F10", "F11", "F12", "F13", "F14", "F15"]
    print row_format.format(*reg_names)
    print row_format.format(*self.fp_registers[8:16])
    reg_names = ["F16", "F17", "F18", "F19", "F20", "F21", "F22", "F23"]
    print row_format.format(*reg_names)
    print row_format.format(*self.fp_registers[16:24])
    reg_names = ["F24", "F25", "F26", "F27", "F28", "F29", "F30", "F31"]
    print row_format.format(*reg_names)
    print row_format.format(*self.fp_registers[24:32])
    print "########################################################################################################################################################"